					...
					<div class="signup-form">
						...
						<div class="switch-form">
							<a href="${pageContext.request.contextPath}/register"><button
									style="background-color: rgba(0, 140, 186, 0.5); /* Green */ border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 0px 2px 32px 2px; cursor: pointer;">User</button></a>
							<a href="${pageContext.request.contextPath}/register-recruiter"><button
									style="background-color: #008CBA; /* Blue */ border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 0px 2px 32px 2px; cursor: pointer;">Recruiter</button></a>
						</div>
