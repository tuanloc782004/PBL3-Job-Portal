...
<body>
	<div class="slider-area ">
		...
		<div class="slider-active">
			<div class="single-slider slider-height d-flex align-items-center"
				data-background="<c:url value = '/assets/img/hero/h1_hero.jpg'/>">
				<div class="container">
					<div class="row">
	...
	<!-- slider Area End--> <!-- Our Services Start -->
	...
	<!-- Our Services End --> <!-- Online CV Area Start -->
	<div class="online-cv cv-bg section-overly pt-90 pb-120"
		data-background="<c:url value = '/assets/img/gallery/cv_bg.jpg'/>">
		<div class="container">
	...
	<!-- Online CV Area End--> <!-- Featured_job_start -->
				...
				<div class="col-xl-10">
						...
						<div class="job-items">
							<div class="company-img">
								<a href="job_details.html"><img
									src="<c:url value = '/assets/img/icon/job-list1.png'/>" alt=""/></a>
							</div>
							<div class="job-tittle">
								<h4><a href="job_details.html">Digital Marketer</a></h4>
								<ul>
					...
					<div class="single-job-items mb-30">
						<div class="job-items">
							<div class="company-img">
								<a href="job_details.html"><img
									src="<c:url value = '/assets/img/icon/job-list2.png'/>" alt=""/></a>
							</div>
							<div class="job-tittle">
								<h4><a href="job_details.html">Digital Marketer</a></h4>
								<ul>
					...
					<div class="single-job-items mb-30">
						<div class="job-items">
							<div class="company-img">
								<a href="job_details.html"><img
									src="<c:url value = '/assets/img/icon/job-list3.png'/>" alt=""/></a>
							</div>
							<div class="job-tittle">
								<h4><a href="job_details.html">Digital Marketer</a></h4>
								<ul>
					...
					<div class="single-job-items mb-30">
						<div class="job-items">
							<div class="company-img">
								<a href="job_details.html"><img
									src="<c:url value = '/assets/img/icon/job-list4.png'/>" alt=""/></a>
							</div>
							<div class="job-tittle">
								<h4><a href="job_details.html">Digital Marketer</a></h4>
								<ul>
	...
	<!-- Featured_job_end --> <!-- How  Apply Process Start-->
	<div class="apply-process-area apply-bg pt-150 pb-150"
		data-background="<c:url value = '/assets/img/gallery/how-applybg.png'/>">
		<div class="container">
			<!-- Section Tittle -->
			<div class="row">
				<div class="col-lg-12">
	...
	<!-- How  Apply Process End--> <!-- Testimonial Start -->
							...
							<div class="testimonial-caption ">
								...
								<div class="testimonial-founder  ">
									<div class="founder-img mb-30">
										<img src="<c:url value = '/assets/img/testmonial/testimonial-founder.png'/>"
	...
	<!-- Testimonial End --> <!-- Support Company Start-->
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6">
					<div class="support-location-img">
						<img src="<c:url value = '/assets/img/service/support-img.jpg'/>" alt=""/>
	...
	<!-- Support Company End--> <!-- Blog Area Start -->
			...
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="home-blog-single mb-30">
						<div class="blog-img-cap">
							<div class="blog-img">
								<img src="<c:url value = '/assets/img/blog/home-blog1.jpg'/>" alt=""/>
								<!-- Blog date -->
				...
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="home-blog-single mb-30">
						<div class="blog-img-cap">
							<div class="blog-img">
								<img src="<c:url value = '/assets/img/blog/home-blog2.jpg" alt='/>"/>
								<!-- Blog date -->
								<div class="blog-date text-center">
									<span>24</span>
									<p>Now</p>
