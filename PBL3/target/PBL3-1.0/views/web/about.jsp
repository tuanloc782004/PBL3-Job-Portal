...
<body>
	...
	<!-- Hero Area End --> <!-- Support Company Start-->
			...
			<div class="row align-items-center">
				...
				<div class="col-xl-6 col-lg-6">
					<div class="support-location-img">
						<img src="${pageContext.request.contextPath}/assets/img/service/support-img.jpg" alt="">
	...
	<!-- Support Company End--> <!-- How  Apply Process Start-->
							...
							<div class="testimonial-caption ">
								...
								<div class="testimonial-founder  ">
									<div class="founder-img mb-30">
										<img src="${pageContext.request.contextPath}/assets/img/testmonial/testimonial-founder.png"
	...
	<!-- Testimonial End --> <!-- Online CV Area Start -->
	<div class="online-cv cv-bg section-overly pt-90 pb-120"
		data-background="${pageContext.request.contextPath}/assets/img/gallery/cv_bg.jpg">
		<div class="container">
	...
	<!-- Online CV Area End--> <!-- Blog Area Start -->
				...
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="home-blog-single mb-30">
						<div class="blog-img-cap">
							<div class="blog-img">
								<img src="${pageContext.request.contextPath}/assets/img/blog/home-blog1.jpg" alt="">
								<!-- Blog date -->
