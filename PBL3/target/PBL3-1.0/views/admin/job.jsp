...
<body>
	<!-- <form action="/PBL3/admin-job" id="formSubmit" method="post"> -->
	<main> <!-- Hero Area End --> <!-- Job List Area Start -->
	...
	<!-- </form> -->
	<script
		src="${pageContext.request.contextPath}/paginator/simple-bootstrap-paginator.js"></script>
	<script>
		var pag = $('#pagination').simplePaginator({
			totalPages : 30,
			visiblePages: 5,
			pageChange : function(page) {
				// $('#').empty().text('Page is ' + page);
				$('#page').val(page);
				$('#formSubmit').submit();
			}
		});
